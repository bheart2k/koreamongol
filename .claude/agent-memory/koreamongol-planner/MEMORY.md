...
- 실측: 가입 2명 / 커뮤니티 글 0 / 30일 이벤트 25건 → 병목은 기능이 아니라 유입·색인
- 확인된 콘텐츠 공백: 장기체류 경로(E-7-4/F-2-7/F-5) 전무, 운전면허 교환 전무, 연말정산 전무, 몽골 카고 전무
- 계측 공백: `analytics.guideView` 정의만 있고 호출처 0 → 가이드 조회가 내부 DB에 안 잡힘
- 상세(추천 Top5·하지 말 것·팩트 리스크): `priorities-2026-09-02.md`
