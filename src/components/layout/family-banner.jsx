...
import { PromoTracker } from '@/components/promo/promo-tracker';
...
const BANNERS = [
  ['hangulhub', HangulHubBanner],
  ['kidsland', KidslandBanner],
];
...
export function FamilyBanner() {
  ...
  const [toId, Banner] = BANNERS[Math.abs(h) % BANNERS.length];

  return (
    <section aria-label="Манай бусад үйлчилгээ">
      <div className="mx-auto max-w-6xl px-4 py-6">
        <PromoTracker from={SELF_ID} to={toId}>
